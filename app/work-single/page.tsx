                            ...
                            <div className="row">
                                <div className="col-lg-8 mx-lg-auto mb-lg-0">
                                    <div className="text-center">
                                        ...
                                        <h3 className="ds-3 mt-3 mb-4 text-dark">Travila - Travel Booking App UI/UX Design</h3>
                                        <p className="text-300 fs-5 mb-0">The project involved creating an intuitive and visually appealing user interface, ensuring that users can effortlessly book flights, hotels, and car rentals all within a single app.</p>
                                    </div>
                                </div>
                                ...
                                <div className="col-lg-8 mx-lg-auto mt-8">
                                    ...
                                    <ul>
                                        <li>
                                            <p className="text-dark fw-bold">
                                                User-Centric Interface: <span className="text-300 fw-medium">Designed a clean and intuitive interface that allows users to navigate through the app with ease, ensuring a smooth and enjoyable booking process.</span>
                                            </p>
                                        </li>
                                        <li>
                                            <p className="text-dark fw-bold">
                                                Integrated Search and Booking: <span className="text-300 fw-medium">Developed an integrated search function that enables users to find and book flights, hotels, and car rentals quickly and efficiently.</span>
                                            </p>
                                        </li>
                                        <li>
                                            <p className="text-dark fw-bold">
                                                Personalized Recommendations: <span className="text-300 fw-medium">Implemented a recommendation system that suggests destinations, accommodations, and activities based on user preferences and past behaviors.</span>
                                            </p>
                                        </li>
                                        <li>
                                            <p className="text-dark fw-bold">
                                                ...
                                                <span className="text-300 fw-medium">
                                                    Integrated a secure payment gateway to ensure that all transactions <span className="text-dark fw-bold">are safe and user data is protected.</span>
                                                </span>
                                            </p>
                                        </li>
                                        <li>
                                            <p className="text-dark fw-bold">
                                                Interactive Maps: <span className="text-300 fw-medium">Added interactive maps to help users explore destinations, find nearby attractions, and get directions.</span>
                                            </p>
                                        </li>
                                    </ul>
                                    ...
                                    <ul>
                                        <li>
                                            <p className="text-dark fw-bold">
                                                Front-End: <span className="text-300 fw-medium">React Native for cross-platform mobile development, ensuring a consistent experience on both iOS and Android devices.</span>
                                            </p>
                                        </li>
                                        <li>
                                            <p className="text-dark fw-bold">
                                                Back-End: <span className="text-300 fw-medium">Node.js and Express for handling server-side logic and database interactions.</span>
                                            </p>
                                        </li>
                                        <li>
                                            <p className="text-dark fw-bold">
