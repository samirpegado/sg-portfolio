...
export default function Skills2() {
	...
	return (
		<>
			...
			<section id="skills" className="section-skills-2 pt-4">
							...
							<div className="position-relative z-1">
								<div className="text-center">
									<div className="d-flex align-items-center justify-content-center">
										...
										<span className="text-linear-4 d-flex align-items-center"> {t('skills.title')} </span>
									</div>
														...
														<ul className="ps-3 d-flex flex-column justify-content-between h-100 position-relative">
															<li className="mb-3">
																<div className="d-flex flex-column flex-md-row gap-2">
																	<p className="text-dark text-nowrap mb-0">{t('skills.frontend')}</p>
																	<span className="text-300">Flutter, HTML, CSS, React</span>
																</div>
															</li>
															<li className="mb-3">
																<div className="d-flex flex-column flex-md-row gap-2">
																	<p className="text-dark text-nowrap mb-0">{t('skills.backend')}</p>
																	<span className="text-300">Supabase, NodeJS, Django</span>
																</div>
															</li>
															<li className="mb-3">
																<div className="d-flex flex-column flex-md-row gap-2">
																	<p className="text-dark text-nowrap mb-0">{t('skills.databases')}</p>
																	<span className="text-300">PostgreSQL, SQLite, MySQL</span>
																</div>
															</li>
															<li className="mb-3">
																<div className="d-flex flex-column flex-md-row gap-2">
																	<p className="text-dark text-nowrap mb-0">{t('skills.tools')}</p>
																	<span className="text-300">Git, Docker, Hetzner, N8N</span>
																</div>
															</li>
															<li className="mb-3">
																<div className="d-flex flex-column flex-md-row gap-2">
																	<p className="text-dark text-nowrap mb-0">{t('skills.others')}</p>
