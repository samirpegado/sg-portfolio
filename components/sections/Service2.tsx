...
export default function Service2() {
	...
	return (
		<>
			...
			<section id="services" className="section-service-2 pt-6">
							...
							<div className="position-relative z-1">
								<div className="text-center">
									<div className="d-flex align-items-center justify-content-center">
										...
										<span className="text-linear-4 d-flex align-items-center"> {t('services.cooperation')} </span>
									</div>
									<h3>
										{t('services.title')} <br />
									...
									<div className="row g-4">
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h6 className="my-3 fw-medium">{t('services.mobileWeb.title')}</h6>
												<p className="fs-7 text-300 fw-regular">{t('services.mobileWeb.description')}</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h6 className="my-3 fw-medium">{t('services.backend.title')}</h6>
												<p className="fs-7 text-300 fw-regular">{t('services.backend.description')}</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h6 className="my-3 fw-medium">{t('services.api.title')}</h6>
												<p className="fs-7 text-300 fw-regular">{t('services.api.description')}</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h6 className="my-3 fw-medium">{t('services.devops.title')}</h6>
												<p className="fs-7 text-300 fw-regular">{t('services.devops.description')}</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h6 className="my-3 fw-medium">{t('services.fullstack.title')}</h6>
												<p className="fs-7 text-300 fw-regular">{t('services.fullstack.description')}</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h6 className="my-3 fw-medium">{t('services.automation.title')}</h6>
												<p className="fs-7 text-300 fw-regular">{t('services.automation.description')}</p>
											</div>
										</div>
									</div>
									<div className="text-center pt-60">
										<p className="text-300">
											{t('services.footer.text')} <br />
											<Link href="#" className="text-primary-2">{t('services.footer.link')}</Link>
										</p>
									</div>
								</div>
							</div>
