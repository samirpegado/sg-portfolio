...
export default function Education2() {
	...
	return (
		<>
			...
			<section id="resume" className="section-education pt-2">
							...
							<div className="rounded-3 border border-1 position-relative h-100 overflow-hidden">
								<div className="box-linear-animation p-md-6 p-3 ">
									<div className="d-flex align-items-center">
										...
										<h5 className="mb-0 ms-2">{t('education.title')}</h5>
									</div>
									<div className="d-flex flex-column h-100 position-relative mt-5">
										<ul className="ps-3">
											<li className="position-relative z-1 mb-3">
												<div className="d-flex gap-2">
													<p className="text-300 text-nowrap fw-regular mb-0">2022-2025:</p>
													<div>
														<span className="text-primary-2">UNINTER - Centro Universitário Internacional</span>
														<p className="text-dark">{t('education.uninter.course')}</p>
													</div>
												</div>
											</li>
											<li className="position-relative z-1 mb-3">
												<div className="d-flex gap-2">
													<p className="text-300 text-nowrap fw-regular mb-0">2018-2022:</p>
													<div>
														<span className="text-primary-2">UFRN - Universidade Federal do Rio Grande do Norte</span>
														<p className="text-dark">{t('education.ufrn.course')}</p>
													</div>
												</div>
											</li>
											<li className="position-relative z-1 mb-3">
												<div className="d-flex gap-2">
													<p className="text-300 text-nowrap fw-regular mb-0">2013-2016:</p>
													<div>
														<span className="text-primary-2">IFRN - Instituto Federal de Educação, Ciência e Tecnologia do Rio Grande do Norte</span>
														<p className="text-dark">{t('education.ifrn.course')}</p>
													</div>
												</div>
											</li>
										</ul>
						...
						<div className="col-lg-6 pt-3">
							<div className="bg-3 rounded-3 border border-1 p-md-6 p-3 position-relative h-100 overflow-hidden">
								<div className="d-flex align-items-center">
									...
									<h5 className="mb-0 ms-2">{t('education.certifications')}</h5>
								</div>
								<div className="d-flex flex-column h-100 position-relative mt-5">
									<ul className="ps-3">
										<li className="position-relative z-1 mb-3">
											<div className="d-flex gap-2">
												...
												<div>
													<span className="text-primary-2">{t('education.flutter.title')}</span>
													<p className="text-dark">{t('education.flutter.description')}</p>
												</div>
											</div>
										</li>
										<li className="position-relative z-1 mb-3">
											<div className="d-flex gap-2">
												...
												<div>
													<span className="text-primary-2">{t('education.meta.title')}</span>
													<p className="text-dark">{t('education.meta.description')}</p>
												</div>
											</div>
										</li>
										<li className="position-relative z-1 mb-3">
											<div className="d-flex gap-2">
												<p className="text-300 text-nowrap fw-regular mb-0">2023:</p>
												<div>
													<span className="text-primary-2">{t('education.dio.title')}</span>
													<p className="text-dark">{t('education.dio.description')}</p>
												</div>
											</div>
										</li>
									</ul>
